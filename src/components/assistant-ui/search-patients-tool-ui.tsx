          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`w-3 h-3 rounded-full ${
                    patient.Gender === "Nam" ? "bg-blue-500" : "bg-pink-500"
                  }`}
                ></div>
                <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xs text-gray-500">Số lần khám</div>
                  <div className="font-medium">{patient.VisitCount} lần</div>
                </div>
              </div>
            </div>
                  ...
                  <div className="min-w-0">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="max-w-xs">{patient.Address}</p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  </div>
      ...
      return (
        <div className="flex items-center gap-2 text-xs mb-2">
          ...
          <span className="text-gray-300">
            {args.purpose ? args.purpose : "Đang thực hiện tìm kiếm bệnh nhân"}
          </span>
        </div>
      );
    }
    ...
    if (status.type === "incomplete" && status.reason === "error") {
      return (
        <div className="flex items-center gap-2 text-xs mb-2">
          ...
          <span className="text-red-500">Lỗi khi tìm kiếm bệnh nhân</span>
        </div>
      );
    }
            ...
            {result.results.length <= 2 ? (
              ...
              <div className="space-y-3">
                {result.results.map((patient) => (
                  <FullPatientCard key={patient.PatientKey} patient={patient} />
                ))}
              </div>
            ) : (
