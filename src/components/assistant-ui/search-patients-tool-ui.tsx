...
>({
	...
	render: ({ args, status, result }) => {
		...
		const FullPatientCard = ({ patient }: { patient: Patient }) => (
			<Card
				className="group hover:shadow-lg hover:-translate-y-1 transition-all duration-200 cursor-pointer border-gray-200 hover:border-blue-300 hover:bg-blue-50/30"
				onClick={() => handlePatientClick(patient.PatientKey)}
			>
				<CardHeader className="pb-4">
					<CardTitle className="flex items-center gap-3 text-base group-hover:text-blue-700 transition-colors">
				...
				<CardContent className="space-y-3">
					<div className="grid gap-3 text-sm">
						<div className="flex items-center gap-3 p-2 rounded-lg bg-gray-50 group-hover:bg-white transition-colors">
							<Calendar className="size-4 text-gray-600 flex-shrink-0" />
						...
						<div className="flex items-center gap-3 p-2 rounded-lg bg-gray-50 group-hover:bg-white transition-colors">
							<Hash className="size-4 text-gray-600 flex-shrink-0" />
							<div className="min-w-0 flex-1">
								<span className="text-gray-500 text-xs block">
									CCCD
								</span>
					...
					<div className="border-t pt-4">
						<div className="flex items-start gap-3">
							<MapPin className="size-4 text-gray-600 mt-1 flex-shrink-0" />
							<div className="min-w-0 flex-1">
